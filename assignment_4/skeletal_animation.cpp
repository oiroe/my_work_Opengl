...
int main()
{
	...
	Model ourModel(FileSystem::getPath("resources/Remy/Remy.dae"));
	Animation idleAnimation(FileSystem::getPath("resources/Idle/Idle.dae"),&ourModel);
	Animation walkAnimation(FileSystem::getPath("resources/Strut_Walking/Strut Walking.dae"), &ourModel);
	Animation runAnimation(FileSystem::getPath("resources/Running/Running.dae"), &ourModel);
	Animation punchAnimation(FileSystem::getPath("resources/Jab_Cross/Jab_Cross.dae"), &ourModel);
	Animation kickAnimation(FileSystem::getPath("resources/Hip Hop Dancing/Hip Hop Dancing.dae"), &ourModel);
